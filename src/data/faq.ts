...
export const FAQ_HOME: Partial<Record<Locale, FaqEntry[]>> = {
  it: [
    ...
    { q: "A che ora sono il check-in e il check-out?", a: "Il check-in è dalle 15:00 e il check-out entro le 10:00. L'ingresso è con smart lock: dalle 15:00 arrivi all'ora che preferisci, in totale autonomia e senza doverci aspettare." },
  ...
  en: [
    ...
    { q: "What are the check-in and check-out times?", a: "Check-in is from 15:00 and check-out by 10:00. Entry is via a smart lock: from 15:00 you can arrive whenever you like, completely on your own and with no need to wait for us." },
  ...
  fr: [
    ...
    { q: "Quels sont les horaires de check-in et de check-out ?", a: "Le check-in est à partir de 15h00 et le check-out avant 10h00. L'entrée se fait par une serrure connectée (smart lock) : à partir de 15h00, vous arrivez à l'heure que vous voulez, en toute autonomie et sans nous attendre." },
  ...
  de: [
    ...
    { q: "Wann sind Check-in und Check-out?", a: "Der Check-in ist ab 15:00 Uhr und der Check-out bis 10:00 Uhr. Der Zugang erfolgt über ein Smart Lock: Ab 15:00 Uhr kommen Sie an, wann Sie möchten – völlig selbstständig und ohne auf uns zu warten." },
  ...
  es: [
    ...
    { q: "¿A qué hora son el check-in y el check-out?", a: "El check-in es a partir de las 15:00 y el check-out antes de las 10:00. La entrada es con cerradura inteligente (smart lock): desde las 15:00 llegas a la hora que quieras, con total autonomía y sin tener que esperarnos." },
  ...
  pt: [
    ...
    { q: "A que horas são o check-in e o check-out?", a: "O check-in é a partir das 15:00 e o check-out até às 10:00. A entrada é com fechadura inteligente (smart lock): a partir das 15:00 chega à hora que quiser, com total autonomia e sem ter de esperar por nós." },
  ...
  nl: [
    ...
    { q: "Hoe laat zijn de check-in en check-out?", a: "Check-in is vanaf 15:00 uur en check-out vóór 10:00 uur. De toegang gaat via een smart lock: vanaf 15:00 uur kom je aan wanneer je wilt, volledig zelfstandig en zonder op ons te hoeven wachten." },
  ...
  pl: [
    ...
    { q: "O której są zameldowanie i wymeldowanie?", a: "Zameldowanie od godziny 15:00, a wymeldowanie do 10:00. Wejście odbywa się przez inteligentny zamek (smart lock): od 15:00 przyjeżdżasz o dowolnej porze, całkowicie samodzielnie i bez czekania na nas." },
  ...
  sv: [
    ...
    { q: "Vilka tider gäller för in- och utcheckning?", a: "Incheckning sker från 15:00 och utcheckning senast 10:00. Entrén sker med ett smart lås (smart lock): från 15:00 kommer du när du vill, helt självständigt och utan att behöva vänta på oss." },
  ...
  ja: [
    ...
    { q: "チェックインとチェックアウトは何時ですか？", a: "チェックインは15:00から、チェックアウトは10:00までです。入口はスマートロック式なので、15:00以降はお好きな時間に、完全にご自身で、私たちを待たずにチェックインできます。" },
  ...
  "zh-cn": [
    ...
    { q: "入住和退房是几点？", a: "入住时间为15:00起，退房时间为10:00前。入口采用智能门锁（smart lock）：15:00之后您可在任意时间自助入住，完全自主，无需等待我们。" },
